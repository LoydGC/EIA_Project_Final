...
**Megawatt Capacity (capacity_mw):** For the purposes of this analysis, megawatt capacity is the maximum output of electricity a generating unit is capable of. It does not always produce at this level, but it is theoretically capable of doing so. Higher numeric values mean higher capability to produce megawatts. The EIA dataset provides a direct variable to represent this information. The MISO dataset required a calculation based on the max of summer_mw and winter_mw to compute nameplate_capacity.  
